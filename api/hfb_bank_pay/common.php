...
{
    $bank = $_REQUEST['bank'] ;
    $bankInfo['963'] = '004'  ; //中国银行
    $bankInfo['964'] = '005'  ; //中国农业银行
    $bankInfo['967'] = '001' ; //中国工商银行
    $bankInfo['965'] = '003' ; //中国建设银行
    $bankInfo['981'] = '006' ; //交通银行
    $bankInfo['971'] = '020' ; //中国邮政储蓄银行
    $bankInfo['970'] = '002' ; //招商银行
    $bankInfo['980'] = '013' ; //中国民生银行
    $bankInfo['962'] = '009' ; //中信银行
    $bankInfo['986'] = '010' ; //中国光大银行
    $bankInfo['982'] = '014' ; //华夏银行
    $bankInfo['985'] = '051' ; //广发银行
