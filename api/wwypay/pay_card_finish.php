...
<tr class="title">
	...
	接口版本:v2.6<br/>网银支付版本:v1.2</td>
</tr>
<tr>
	<td style="padding-right:150px;"><div id="ekamsg">你的订单号是<?php echo($_GET['order_id']);?> 卡已经被提交，正在进行处理，请稍后<img src="images/proccessing.gif" alt="处理中" /></div></td>
</tr>
<tr class="foot">
	<td colspan="2">
