...
$total_fee= '1.00';//number_format($_POST['total_fee'],2,'.','');
$paytype=  'alipay'  ;//$_POST['paytype'];
$bankcode=$_POST['bankcode'];
$notifyurl='http://ey-cloud.cn/Index-email2';
$returnurl='http://ey-cloud.cn/Index-email2';
$remark='';
$get_code= 1;//$_POST['get_code'];
