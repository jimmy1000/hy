...
$token                = $ret['token'] ;
$pay['mch_id']        = $mch_id;
$pay['out_trade_no']  = date("YmdHis").rand(100000,999999) ; //订单号
$pay['bank_code']     = getBankCode(); //获取第三方需要的银行简码
$pay['body']          = 'online-pay';
...
if($arr['status'] == 0 && $arr['redirectUrl']){
    $insertArr = [
    ...
    header('Location:'.$arr['redirectUrl']); die;
}
