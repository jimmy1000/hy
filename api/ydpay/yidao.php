...
class yidao
{
    private $requestUrl = "http://api.easypay168.cn/externalSendPay/rechargepay.do";
    //商户配置
    private $merchantCode = "MERCOONT8967371352925520914"; //商户号
    private $TardeCode    = "pC7QYrsRFFISnPbi";  //商户key
    private $merKey       = "qFIYUFEUoOqosHa3"; //签名key

    private $version    = "1.0.1";
    private $notifyUrl  = "http://payhy.8889s.com/api/ydpay/callback.php";
    private $returnUrl  = "http://payhy.8889s.com";
     ...
     * @param $merKey  报文加密    (商户密钥)
     * @param $TardeCode 签名KEY   (MD5私钥)
     */
     ...
     */
    public function pay($orgOrderNo, $subject, $amount, $source)
    {
