...
$sign = strtolower(md5("customerid={$response['customerid']}&status={$response['ststus']}&sdpayno={$response['sdpayno']}&sdorderno={$order_id}&total_fee={$response['total_fee']}&paytype={$response['paytype']}&{$app_key}"));
