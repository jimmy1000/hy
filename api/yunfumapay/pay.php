...
$data = [
    ...
    'bankcode' => $type['code'] == 'bank' ? getBankAbbreviation($_REQUEST['bank']) : '',				 //银行编号
    'notifyurl' => $notify_url,				 //异步通知URL
    'returnurl' => $return_url,				 //同步跳转URL
    'get_code' => '0'
];

$sign = "version={$data['version']}&customerid={$app_id}&total_fee={$coin}&sdorderno={$order_id}&notifyurl={$data['notifyurl']}&returnurl={$data['returnurl']}&{$app_key}";
