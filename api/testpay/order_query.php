<?php
/* *
 *功能：亿宝通h5支付单笔订单查询接口（目前只能查询距离下单时间12小时以内的）
 *版本：3.0
 *日期：2017-09-20
 *说明：
...
*/
	...
	$merchant_code = "108001002002";//商户号，108001002002是测试商户号，调试时要更换商家自己的商户号！
...
?>
<!-- 以post方式提交所有接口参数到亿宝通查询网关https://query.yibaotown.com/query -->
<html>
	<head>
		<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
	</head>
	<body onLoad="javascript:document.getElementById('queryForm').submit();">
		<form  id="queryForm" action="https://query.yibaotown.com/query" method="post"  target="_self">
