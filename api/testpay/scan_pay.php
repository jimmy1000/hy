...
///////////////////////////  初始化接口参数  //////////////////////////////
/**
接口参数请参考亿宝通扫码支付文档，除了sign参数，其他参数都要在这里初始化
*/
	include_once("./merchant.php");
	
	$merchant_code = $_POST["merchant_code"];//商户号，108001002002是测试商户号，调试时要更换商家自己的商户号

	$service_type = $_POST["service_type"];//支付宝：alipay_scan 
...
/**
curl方法提交支付参数到亿宝通扫码网关https://api.yibaotown.com/gateway/api/h5apipay，并且获取返回值
*/
	...
	$ch = curl_init();	
	curl_setopt($ch,CURLOPT_URL,"https://api.yibaotown.com/gateway/api/h5apipay");
